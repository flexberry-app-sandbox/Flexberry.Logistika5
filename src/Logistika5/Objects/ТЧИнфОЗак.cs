...
namespace IIS.Logistika5
{
    ...
    public class ТЧИнфОЗак : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Logistika5.Груз fГруз;
        ...
        [PropertyStorage(new string[] {
                "Груз"})]
        [NotNull()]
        public virtual IIS.Logistika5.Груз Груз
        {
            get
            {
                ...
                IIS.Logistika5.Груз result = this.fГруз;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Logistika5.ДокумПостав.
        /// </summary>
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТЧИнфОЗакE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТЧИнфОЗакE", typeof(IIS.Logistika5.ТЧИнфОЗак));
                }
            }
        }
    }
    ...
    public class DetailArrayOfТЧИнфОЗак : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Logistika5.DetailArrayOfТЧИнфОЗак members)

        // *** End programmer edit section *** (IIS.Logistika5.DetailArrayOfТЧИнфОЗак members)
        ...
        /// </summary>
        public DetailArrayOfТЧИнфОЗак(IIS.Logistika5.ДокумПостав fДокумПостав) : 
                base(typeof(ТЧИнфОЗак), ((ICSSoft.STORMNET.DataObject)(fДокумПостав)))
        {
        }
        
        public IIS.Logistika5.ТЧИнфОЗак this[int index]
        {
            get
            {
                return ((IIS.Logistika5.ТЧИнфОЗак)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Logistika5.ТЧИнфОЗак dataobject)
        {
