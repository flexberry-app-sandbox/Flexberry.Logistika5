...
namespace IIS.Logistika5
{
    ...
    public class ТЧИнфОКонт : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Logistika5.ДокумПостав fДокумПостав;
        
        private IIS.Logistika5.ЗагрузКонтейн fЗагрузКонтейн;
        
        private IIS.Logistika5.ЗагрузкаБаржи fЗагрузкаБаржи;
        ...
        [PropertyStorage(new string[] {
                "ДокумПостав"})]
        [NotNull()]
        public virtual IIS.Logistika5.ДокумПостав ДокумПостав
        {
            get
            {
                ...
                IIS.Logistika5.ДокумПостав result = this.fДокумПостав;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Logistika5.ЗагрузкаБаржи.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "ЗагрузкаБаржи"})]
        public virtual IIS.Logistika5.ЗагрузкаБаржи ЗагрузкаБаржи
        {
            get
            {
                ...
                IIS.Logistika5.ЗагрузкаБаржи result = this.fЗагрузкаБаржи;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТЧИнфОКонтE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТЧИнфОКонтE", typeof(IIS.Logistika5.ТЧИнфОКонт));
                }
            }
        }
    }
    ...
    public class DetailArrayOfТЧИнфОКонт : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Logistika5.DetailArrayOfТЧИнфОКонт members)

        // *** End programmer edit section *** (IIS.Logistika5.DetailArrayOfТЧИнфОКонт members)
        ...
        /// </summary>
        public DetailArrayOfТЧИнфОКонт(IIS.Logistika5.ЗагрузкаБаржи fЗагрузкаБаржи) : 
                base(typeof(ТЧИнфОКонт), ((ICSSoft.STORMNET.DataObject)(fЗагрузкаБаржи)))
        {
        }
        
        public IIS.Logistika5.ТЧИнфОКонт this[int index]
        {
            get
            {
                return ((IIS.Logistika5.ТЧИнфОКонт)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Logistika5.ТЧИнфОКонт dataobject)
        {
