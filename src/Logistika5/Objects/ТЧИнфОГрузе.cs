...
namespace IIS.Logistika5
{
    ...
    public class ТЧИнфОГрузе : ICSSoft.STORMNET.DataObject
    {
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Logistika5.ЗагрузКонтейн.
        /// </summary>
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТЧИнфОГрузеE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТЧИнфОГрузеE", typeof(IIS.Logistika5.ТЧИнфОГрузе));
                }
            }
        }
    }
    ...
    public class DetailArrayOfТЧИнфОГрузе : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Logistika5.DetailArrayOfТЧИнфОГрузе members)

        // *** End programmer edit section *** (IIS.Logistika5.DetailArrayOfТЧИнфОГрузе members)
        ...
        /// </summary>
        public DetailArrayOfТЧИнфОГрузе(IIS.Logistika5.ЗагрузКонтейн fЗагрузКонтейн) : 
                base(typeof(ТЧИнфОГрузе), ((ICSSoft.STORMNET.DataObject)(fЗагрузКонтейн)))
        {
        }
        
        public IIS.Logistika5.ТЧИнфОГрузе this[int index]
        {
            get
            {
                return ((IIS.Logistika5.ТЧИнфОГрузе)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Logistika5.ТЧИнфОГрузе dataobject)
        {
