...
namespace IIS.Logistika5
{
    ...
    [View("БаржиE", new string[] {
            ...
            "Грузопод as \'Грузоподъемность\'",
            "Длина as \'Длина\'",
            "Ширина as \'Ширина\'",
            "ВысотаБаржи as \'Высота баржи\'",
            "ОбъемБаржи as \'Объем баржи\'"})]
    ...
    public class Баржи : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Logistika5.DetailArrayOfТЧРасписание fТЧРасписание;
        ...
        public virtual IIS.Logistika5.DetailArrayOfТЧРасписание ТЧРасписание
        {
            get
            {
                ...
                {
                    this.fТЧРасписание = new IIS.Logistika5.DetailArrayOfТЧРасписание(this);
                }
                IIS.Logistika5.DetailArrayOfТЧРасписание result = this.fТЧРасписание;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View БаржиE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("БаржиE", typeof(IIS.Logistika5.Баржи));
                }
            }
            ...
            public static ICSSoft.STORMNET.View БаржиL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("БаржиL", typeof(IIS.Logistika5.Баржи));
                }
            }
        }
    }
