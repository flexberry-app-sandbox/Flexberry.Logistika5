...
namespace IIS.Logistika5
{
    ...
    public class ДокумРезультП : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Logistika5.DetailArrayOfТЧДостКон fТЧДостКонт;
        
        private IIS.Logistika5.DetailArrayOfТЧСвобМест fТЧСвобМест;
        ...
        public virtual IIS.Logistika5.DetailArrayOfТЧДостКон ТЧДостКонт
        {
            get
            {
                ...
                {
                    this.fТЧДостКонт = new IIS.Logistika5.DetailArrayOfТЧДостКон(this);
                }
                IIS.Logistika5.DetailArrayOfТЧДостКон result = this.fТЧДостКонт;
        ...
        public virtual IIS.Logistika5.DetailArrayOfТЧСвобМест ТЧСвобМест
        {
            get
            {
                ...
                {
                    this.fТЧСвобМест = new IIS.Logistika5.DetailArrayOfТЧСвобМест(this);
                }
                IIS.Logistika5.DetailArrayOfТЧСвобМест result = this.fТЧСвобМест;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ДокумРезультПE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДокумРезультПE", typeof(IIS.Logistika5.ДокумРезультП));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ДокумРезультПL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДокумРезультПL", typeof(IIS.Logistika5.ДокумРезультП));
                }
            }
        }
    }
