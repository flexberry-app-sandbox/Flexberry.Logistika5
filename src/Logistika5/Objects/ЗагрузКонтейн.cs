...
namespace IIS.Logistika5
{
    ...
    public class ЗагрузКонтейн : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Logistika5.Контейнеры fКонтейнеры;
        
        private IIS.Logistika5.DetailArrayOfТЧИнфОГрузе fТЧИнфОГрузе;
        ...
        [PropertyStorage(new string[] {
                "Контейнеры"})]
        [NotNull()]
        public virtual IIS.Logistika5.Контейнеры Контейнеры
        {
            get
            {
                ...
                IIS.Logistika5.Контейнеры result = this.fКонтейнеры;
        ...
        public virtual IIS.Logistika5.DetailArrayOfТЧИнфОГрузе ТЧИнфОГрузе
        {
            get
            {
                ...
                {
                    this.fТЧИнфОГрузе = new IIS.Logistika5.DetailArrayOfТЧИнфОГрузе(this);
                }
                IIS.Logistika5.DetailArrayOfТЧИнфОГрузе result = this.fТЧИнфОГрузе;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ЗагрузКонтейнE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗагрузКонтейнE", typeof(IIS.Logistika5.ЗагрузКонтейн));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ЗагрузКонтейнL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗагрузКонтейнL", typeof(IIS.Logistika5.ЗагрузКонтейн));
                }
            }
        }
    }
