...
export let Model = Mixin.create({
  ...
  докумПостав: DS.belongsTo('i-i-s-logistika5-докум-постав', { inverse: null, async: false }),
  тЧДостКонт: DS.hasMany('i-i-s-logistika5-т-ч-дост-кон', { inverse: 'докумРезультП', async: false }),
  тЧСвобМест: DS.hasMany('i-i-s-logistika5-т-ч-своб-мест', { inverse: 'докумРезультП', async: false })
});
...
export let defineProjections = function (modelClass) {
  modelClass.defineProjection('ДокумРезультПE', 'i-i-s-logistika5-докум-результ-п', {
    ...
    тЧДостКонт: hasMany('i-i-s-logistika5-т-ч-дост-кон', 'Доставленные контейнеры', {
    ...
    тЧСвобМест: hasMany('i-i-s-logistika5-т-ч-своб-мест', 'Свободное место в контейнерах', {
